...
let handler = async (m, { conn, usedPrefix: _p }) => {
  try {
    ...
    let ArdhiXs = { externalAdReply: { 
      showAdAttribution: true,
               mediaUrl: urlinstagram,    //Url ig/yt/dll
                  mediaType: 30,
                  title: `ʜᴀɪ, ${name} ! 👋`,
                  body: wm,
                  thumbnailUrl: ``,
   ...
   return conn.sendMessage(m.chat, {
        image: await(await fetch(thumbmenu1)).buffer(),
        caption: text.trim(),
        buttons: [
        ...
        headerType: 'IMAGE',
  contextInfo: ArdhiXs
  }, { userJid: m.chat, quoted: m, ephemeralExpiration:86400})
